from basic_backend import CrudOperation
...
class ModelBasic(object):
    ...
    def create_item(self, **kwargs):
        return self.operation.create.item(**kwargs)

    def create_items(self, items):
        return self.operation.create.all(items)

    def read_item(self, **kwargs):
        return self.operation.read.item(**kwargs)

    def read_items(self):
        return self.operation.read.all()

    def update_item(self, **kwargs):
        return self.operation.update.item(**kwargs)

    def delete_item(self, **kwargs):
        return self.operation.delete.item(**kwargs)
